...
import { Factory, TrendingUp, Package, DollarSign, ChevronDown, Users } from 'lucide-react'
  ...
  return (
    <div className="space-y-5 sm:space-y-6 page-enter">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-5">
        ...
        {activeSupplier && (
          <SupplierPersonaView supplier={activeSupplier} customers={state.customers} />
        )}
      </div>
...
function SupplierPersonaView({ supplier, customers }: { supplier: Supplier; customers: Customer[] }) {
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-slate-700">
              {supplier.mfrName} Shopper Persona
            </h3>
            <span className="text-xs text-slate-400">({formatNumber(supplierCustomers.length)} shoppers)</span>
          </div>
          <PersonaPanel
